...
FileDefinition definition = new FileDefinition("BAPLIE", new Version(2, 2, 1));

definition.SegmentSeparator = '\'';
definition.ElementSeparator = '+';
definition.DataElementSeparator = ':';
definition.EscapeCharacter = '?';

definition.Segments = new Segment[]
{
...
using (var reader = new StreamReader(filePath))
{
    try
    {
        ...
        var validationErrors = parser.Validate();
